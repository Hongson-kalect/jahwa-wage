...
export default function Overview(props: IOverviewProps) {
  return (
    <div
      className="mx-4 flex justify-evenly border-gray-400 py-2"
      style={{ borderBottom: "1px solid #bebebe" }}
    >
      <div className="flex h-20 w-1/4 flex-col justify-between rounded-lg p-2">
        <p className="text-xs text-gray-300">Tổng ngày</p>
        <div className="text-center text-3xl font-medium text-white">28</div>
      </div>
      <div className="flex h-20 w-1/4 flex-col justify-between rounded-lg p-2">
        <p className="text-xs text-gray-300">Giờ làm</p>
        <div className="text-center text-3xl font-medium text-white">240</div>
      </div>
      <div className="flex h-20 w-1/4 flex-col justify-between rounded-lg p-2">
        <p className="text-xs text-gray-300">Tăng ca</p>
