  ...
  return (
    <div className="relative">
      <div className="mb-2 flex items-center justify-between">
        <p className="text-sm font-medium">{t("common.monthReport")}</p>
      ...
      <StyledInfo className="relative z-10 flex h-[150px] w-full flex-col rounded-3xl bg-[#000000] py-2 shadow-md shadow-gray-900">
        ...
        <div className="relative z-10 grid w-full flex-1 grid-cols-1 grid-rows-3 gap-1 px-3 py-2 pt-0">
          <table className="w-full">
            <tbody className="">
              <tr className="mx-">
                <td colSpan={4}>
                  <p
                    className="-ml-1 text-left text-xs font-light italic text-gray-500"
                    style={{ fontSize: "10px" }}
                  >
              ...
              <tr>
                <td>
                  <span className="text-center text-sm text-slate-900">
              ...
              <tr>
                <td colSpan={4}>
                  <p
                    className="-ml-1 text-left text-xs italic text-gray-500"
                    style={{ fontSize: "10px" }}
                  >
