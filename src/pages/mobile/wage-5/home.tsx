...
export interface IMobileWage5Props {}

export default function MobileWage5(props: IMobileWage5Props) {
  return (
...
const Header = () => {
  ...
  return (
    <div>
      <div
        className="z-[999] flex w-full flex-col items-center justify-between bg-[#e2e8f088] px-2 py-1 pt-3 text-white"
