...
export default function ChangeDate(props: IChangeDateProps) {
  ...
  return (
    <div className="relative mt-2 rounded-lg bg-white p-2 py-2 pt-3 text-white shadow shadow-gray-400">
      <p className="absolute right-2 top-0.5 text-xs font-light text-gray-400">
        Chi trả: 10/11/2024
      </p>
      <div className="pt-2">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            {isYear ? (
              <p className="text-xl font-medium text-blue-600">Lương năm</p>
            ) : (
              <p className="text-xl font-medium text-blue-600">Lương tháng</p>
            )}
          </div>

          <DatePicker
            size="large"
            className="h-8 w-32 border-black"
            picker={wageType}
            allowClear={false}
